...
await page.evaluate(() => { const g = window.__game; g.collected = g.cfg.goal * 2 - 1; g.lock = 0.01 })
await page.waitForTimeout(400)
await page.evaluate(() => { const g = window.__game; if (g.state === 'play') { g.collected = g.cfg.goal * 2; g.lock = 0.01 } })
